...
def upgrade():
    op.create_table('bidi_fastbtc_transfer',
    ...
    sa.Column('status', sa.Enum('NOT_APPLICABLE', 'NEW', 'SENDING', 'MINED', 'REFUNDED', 'RECLAIMED', 'INVALID', name='bidi_fastbtc_transferstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_bidi_fastbtc_transfer_event_block_timestamp'), 'bidi_fastbtc_transfer', ['event_block_timestamp'], unique=False)
    op.create_index('ix_chain_transfer_id', 'bidi_fastbtc_transfer', ['chain', 'transfer_id'], unique=False)


def downgrade():
    op.drop_index('ix_chain_transfer_id', table_name='bidi_fastbtc_transfer')
    op.drop_index(op.f('ix_bidi_fastbtc_transfer_event_block_timestamp'), table_name='bidi_fastbtc_transfer')
