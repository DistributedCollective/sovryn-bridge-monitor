...
def upgrade():
    ...
    op.create_table('block_info',
    sa.Column('block_chain_id', sa.Integer(), nullable=False),
    sa.Column('block_number', sa.Integer(), nullable=False),
    sa.Column('timestamp', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['block_chain_id'], ['block_chain.id'], name=op.f('fk_block_info_block_chain_id_block_chain')),
    sa.PrimaryKeyConstraint('block_chain_id', 'block_number', name=op.f('pk_block_info'))
    )
