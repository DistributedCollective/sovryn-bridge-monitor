...
def upgrade():
    op.create_table('fastbtc_in_transfer',
    ...
    sa.Column('status', sa.Enum('INITIATED', 'SUBMITTED', 'PARTIALLY_CONFIRMED', 'EXECUTED', 'INVALID', name='fastbtc_in_transferstatus'), nullable=False),
    ...
    op.create_index('ix_fastbtc_in_chain_tx_id', 'fastbtc_in_transfer', ['chain', 'multisig_tx_id'], unique=False)
    op.create_index(op.f('ix_fastbtc_in_transfer_executed_block_timestamp'), 'fastbtc_in_transfer', ['executed_block_timestamp'], unique=False)
    op.create_index(op.f('ix_fastbtc_in_transfer_submission_block_timestamp'), 'fastbtc_in_transfer', ['submission_block_timestamp'], unique=False)

def downgrade():
    op.drop_index(op.f('ix_fastbtc_in_transfer_submission_block_timestamp'), table_name='fastbtc_in_transfer')
    op.drop_index(op.f('ix_fastbtc_in_transfer_executed_block_timestamp'), table_name='fastbtc_in_transfer')
