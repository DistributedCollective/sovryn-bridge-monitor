...
def upgrade():
    ...
    sa.Column('amount_received', sa.Numeric(precision=40, scale=32), nullable=False),
    ...
    sa.ForeignKeyConstraint(['wallet_id'], ['btc_wallet.id'], name=op.f('fk_btc_wallet_transaction_wallet_id_btc_wallet')),
    sa.PrimaryKeyConstraint('wallet_id', 'tx_hash', name=op.f('pk_btc_wallet_transaction'))
    )
